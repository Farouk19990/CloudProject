...
--
-- Hôte : localhost:3306
-- Généré le : lun. 01 mai 2023 à 14:59
...
CREATE TABLE `boutiques` (
  ...
  `logo` varchar(255) COLLATE utf8mb4_swedish_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_swedish_ci NOT NULL,
...
INSERT INTO `utilisateurs` (`id`, `name`, `email`, `adresse`, `role`, `login`, `password`, `villeId`, `boutiqueId`) VALUES
(1, 'ZaraAdmin', 'Zara@gmail.com', 'Mall Azur City', 2, 'ZaraAdmin', '$2b$12$Qj0UL3uAPlcf4eh9ikx.B.9YuLsO1RSpkXs8fDbY9x4ZKN.z0GLdK', 23, 1),
(2, 'HMdmin', 'HM@gmail.com', 'Mall of Sousse', 1, 'AdminHM', '$2b$12$J//ntY.ZQtN7MEwYajlyDuW2OsY2zgGSldtzP0pO.06Tlodjs.nAe', 20, 2),
(3, 'AdminStradivarius', 'Stradivarius@gmail.com', 'Mall of Sousse', 2, 'AdminStradivarius', '$2b$12$SNmA4.pTBYIQOG19n.NWuumb6ey/2b9KQgJYnvgoG1KskkVHILtU6', 20, 3),
(4, 'AdminBershka', 'Bershka@gmail.com', 'Mall of sousse', 1, 'AdminBershka', '$2b$12$MLNSICs0raG8ZeZZvuLL/.vENxvDJU5Am3.VK.fhEhwG1nsirg4ye', 20, 4),
(5, 'AdminPull&Bear', 'Pull&Bear@gmail.com', 'Azur City Mall', 1, 'AdminPull&Bear', '$2b$12$F0veIkRhz9PvnDarlbPoSeITZgTe.Ks.hWAv.GlqNUtB9CBlDi5cy', 23, 5),
(6, 'AdminMango', 'Mango@gmail.com', 'Azur City Mall', 2, 'AdminMango', '$2b$12$HkUZPxVw5YW6tytvxunE1O5Mos1rd/mg3uPY/GRcTlVwTwblpGZYy', 23, 6);
